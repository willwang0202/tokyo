...
const AREAS = {
  ...
  akiba: {
    ...
    food: [
      { name: '鳥つね自然洞', tag: '末広町・親子丼', note: '米其林必比登推薦，比內地雞親子丼滑嫩到犯規', rating: 4.3, placeId: null, lat: 35.7019, lng: 139.7726 },
      { name: 'かんだやぶそば', tag: '神田・老舖蕎麥麵', note: '1880 年創業的東京蕎麥麵御三家，古民家建築', rating: 4.1, placeId: null, lat: 35.6962, lng: 139.7666 },
      { name: 'ぼたん', tag: '神田・雞肉壽喜燒', note: '1897 年創業，炭火鳥鍋一本勝負，老屋座敷體驗', rating: 4.3, placeId: null, lat: 35.6953, lng: 139.7688 },
      ...
      { name: '牛丼専門サンボ', tag: '牛丼', note: '秋葉原傳說級牛丼，只此一家、便宜大碗', rating: 4.2, placeId: null, lat: 35.7002, lng: 139.7699 },
    ],
    shops: [
  ...
  shibuya: {
    ...
    shops: [
      ...
      { name: 'SHIBUYA SKY', tag: '渋谷スクランブルスクエア 屋上・展望台', note: '229m 露天展望台，日落時段最搶手；回程的長手扶梯夜景隧道超夢幻，必拍', lat: 35.6585, lng: 139.7025 },
  ...
  shinjuku: {
    ...
    food: [
      ...
      { name: '新宿割烹 中嶋', tag: '割烹料理・米其林一星', note: '中午沙丁魚定食千圓有找，晚上是正統會席，CP 值傳奇', rating: 4.2, placeId: null, lat: 35.6899, lng: 139.7036 },
      { name: '天ぷら 船橋屋 本店', tag: '天婦羅老舖', note: '1950 年開業，職人現炸套餐比銀座親民', rating: 4.2, placeId: null, lat: 35.6907, lng: 139.7032 },
      { name: '時屋', tag: '西新宿・銅鑼燒刨冰老舖', note: '1948 年開業，傳說是哆啦A夢銅鑼燒的原型，夏天刨冰也有名', rating: 4.0, placeId: null, lat: 35.6929, lng: 139.6999 },
...
const DAYS = [
  ...
  },
  {
    ...
    events: [
      ...
      { time: '16:30', icon: ShoppingBag, title: 'LaLaport Toyosu', desc: '就在 teamLab 隔壁，海濱商場逛一圈；晚餐訂在新橋，17:15 前要離開', area: 'daiba', maps: 'ららぽーと豊洲' },
      { time: '17:15', icon: Train, title: '搭車前往新橋', desc: '百合海鷗號豐洲 → 新橋，全線約 25 分鐘', type: 'transit', maps: '新橋駅' },
      { time: '18:00', icon: Utensils, title: 'TRATT. USHIGORO 新橋店', desc: '已訂位 5 人・純訂席（餐點現場點），A5 和牛「町燒肉」，新橋站徒步 1 分鐘。用餐時間 1 小時 45 分，電話 03-6205-7429（訂位編號在訂位確認信裡）。', maps: 'TRATT. USHIGORO 新橋店' },
      { time: '20:00', icon: Moon, title: '返回 Grand Nikko Tokyo Daiba', desc: '百合海鷗號新橋 → 台場，約 15 分鐘', area: 'daiba', showBadge: false, maps: 'グランドニッコー東京 台場' },
    ],
  },
  {
    ...
    events: [
      ...
      { time: '16:00', icon: Building2, title: '新宿逛街', desc: '伊勢丹、Don Quijote，補伴手禮／藥妝；晚餐 18:00，記得留時間走到歌舞伎町', area: 'shinjuku', maps: '伊勢丹新宿店' },
      { time: '18:00', icon: Utensils, title: '月亭 新宿本店', desc: '已訂位 5 人・個室，歌舞伎町開業四十餘年的老字號，會席、涮涮鍋與壽喜燒。永和第一大樓 4F，西武新宿站徒步 3 分、JR 新宿站徒步 7 分，電話 03-3209-9681。取消請提前 66 小時。', area: 'shinjuku', showBadge: false, maps: '月亭 新宿本店' },
